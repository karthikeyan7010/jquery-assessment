$(document).ready(function() {
    ...
    $("#submit").click(function() {
        ...
        if (rows.length < 5) {
            alert("Add more then five colum");
            return false
        }
        ...
        for (let i = 1, j = 0; i <= rows.length; i++, j++) {
            odd[j] = Number($('#odd-id' + i).val());
            vow[j] = $('#vow-id' + i).val();
            sor[j] = Number($('#sor-id' + i).val());
            lar[j] = Number($("#lar-id" + i).val());
        ...
        function large(lar) {
            ...
            $("#lar").text("[" + "min==" + minValue + "]" + "[" + "max==" + maxValue + "]")
        }
        large(lar);
        ...
        function countVowels(vow) {
            ...
            for (let i = 0; i < vow.length; i++) {
                ...
                console.log(name + "contains " + counts + "vowels" + "<br>");
                arr1.push(name + "contains " + counts + "vowels" + "<br>");
                $("#vow").text(arr1)
